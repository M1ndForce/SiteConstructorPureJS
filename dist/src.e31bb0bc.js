...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)((0, _utils.col)("<".concat(tag, ">").concat(this.value, "</>")), (0, _utils.css)(styles));
    }
  }]);
...
var text = 'Modern JavaScript Frameworks like Angular, React and Vue.js makes it very easy to build complex single page web applications. However, using a those frameworks is not mandatory and you can also go with plain and pure JavaScript.';
var model = [new _block.TitleBlock('Site constructor on pure JavaScript', {
  tag: 'h2',
  styles: {
...
}), new _block.ColumnsBlock(['App on pure js', 'OOP principles', 'JavaScript - EASY'], {
  styles: {
...
}), new _block.TextBlock("".concat(text), {
  styles: {
...
exports.model = model;
},{"./assets/image.png":"assets/image.png","./classes/block":"classes/block.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
